          ...
          <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div>
                <input type="hidden" name="id" value="{{$furniture['id']}}">
                  <input type="hidden" name="owner" value="{{$furniture['owner']}}">
                      <input type="hidden" name="categories" value="{{$furniture['categories']}}">
                       <input type="hidden" name="phoneNumber" value="{{$furniture['phoneNumber']}}">
            <h6>Title</h6><p style="font-size: 12px">*max 75 characters</p></div>
            <input type="text" name="title" value="{{$furniture['title']}}">
             <h6>Type</h6>
             <select id="drop-down" name="type" class="browser-default custom-select">
                <option selected="{{$furniture['type']}}" >{{$furniture['type']}}</option>
             ...
             <select id="drop-down" name="condition" class="browser-default custom-select">
              <option selected="{{$furniture['condition']}}" >{{$furniture['condition']}}"</option>
            ...
            <select id="drop-down" name="location" class="browser-default custom-select">
             <option selected="{{$furniture['location']}}" >{{$furniture['location']}}</option>
            ...
            <h6>Description</h6>
            <textarea rows="2" cols="25" name="description" placeholder="Description">{{$furniture['description']}}</textarea>
            
            <div class="form-group">
            <h6>Price</h6>
            <div class="price">
  <h6>IDR (Indonesian rupiah)</h6>
  <input class="pricetag input-currency" type="text" type-currency="IDR" name="price" value="{{$furniture['price']}}">
